...
//        builder.setPositiveButton(getString(R.string.change_txt), null); (heralde strings xml'den alıyordu,direk kendim yazdım)
//        builder.setNegativeButton(getString(R.string.close_txt), null);
                builder.setPositiveButton("DEĞİŞTİR", null);
